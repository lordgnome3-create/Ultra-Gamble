...
local function CreateMainFrame()
	...
	-- Starting number editbox (anchor to frame right edge first)
	local drEditbox = CreateFrame("EditBox", "PhantomGamble_DR_EditBox", f)
	drEditbox:SetWidth(45)
	drEditbox:SetHeight(20)
	drEditbox:SetPoint("TOPRIGHT", f, "TOPRIGHT", -25, -48)
	...
	-- Starting number label (anchor to editbox)
	local drStartLabel = f:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
	drStartLabel:SetPoint("RIGHT", drEditbox, "LEFT", -5, 0)
	drStartLabel:SetText("|cffffffffStart:|r")

	-- Gold wager editbox (anchor to frame right edge)
	local drGoldEditbox = CreateFrame("EditBox", "PhantomGamble_DR_GoldEditBox", f)
	drGoldEditbox:SetWidth(45)
	drGoldEditbox:SetHeight(20)
	drGoldEditbox:SetPoint("TOPRIGHT", drEditbox, "BOTTOMRIGHT", 0, -8)
	...
	-- Gold wager label (anchor to editbox)
	local drGoldLabel = f:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
	drGoldLabel:SetPoint("RIGHT", drGoldEditbox, "LEFT", -5, 0)
	...
	drStartBtn:SetPoint("TOP", drGoldEditbox, "BOTTOM", -35, -8)
